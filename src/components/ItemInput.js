...
export function AddItem({ setItem, setCheck, setPrice, setPerson, setIsInputing, item, check, price, person }) {
    return(
        <Form>
            <Row>
                <Col>
                ...
                <Col>
                    <Button value="Done" onClick={() => setIsInputing(false)} >Done</Button>
                </Col>
            </Row>
        </Form>
    );
...
export default function ItemInput({ check, setCheck, setIsInputing, setTax, setTip }) {
    ...
    return(
        <div>
            ...
            <AddItem {...{ setItem, setCheck, setPrice, setPerson, setIsInputing, item, check, price, person }} />
        </div>
    );
}